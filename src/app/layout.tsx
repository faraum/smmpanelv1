        ...
        {process.env.NEXT_PUBLIC_WHATSAPP && (
          <div className="fixed bottom-6 right-6 z-40 h-14 w-14">
            ...
            <a
              ...
              className="absolute inset-0 flex items-center justify-center rounded-full bg-green-500 shadow-xl shadow-green-500/40 hover:bg-green-400 hover:shadow-green-500/60 transition-all hover:scale-110 active:scale-95"
