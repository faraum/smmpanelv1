      ...
      <body className="min-h-screen bg-[#0a0a0f] text-white antialiased">
        ...
        {process.env.NEXT_PUBLIC_WHATSAPP && (
          <a
            ...
            className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-xl shadow-green-500/40 hover:bg-green-400 hover:shadow-green-500/60 transition-all hover:scale-110 active:scale-95"
